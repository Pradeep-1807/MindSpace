...
const InfoAlert = ({isVisible, title, message}) => {
  ...
  return (
    ...
    <div className='absolute right-1 sm:right-10 top-10 border-2 border-blue-500 z-50 flex w-[95%] sm:w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800'>
